<template>
    <div class="multiple-select" :class="{open : dropdownShowRef,disabled:disabled}">
        ...
        <transition name="slide-down">
            <div ref="dropdownRef" class="dropdown" tabindex="-1" v-if="dropdownShowRef" @blur="dropdownBlur">
                <div class="search-wrap"  v-if="noSearch !== true">
        ...
        function filter(searchText = '') {
            ...
            if (searchText) {
                if (oldSearchText !== searchText) {
                    ...
                    filterList = listRef.value.filter(a => 
													  a.valueName.toString().includes(searchText))
                }
                return filterList;
            }
        ...
        function setViewValue() {
            ...
            if (modelValue.length) {
                ...
                if (modelValue.length > 4) {
                    ...
                    viewValue.value = selectList.map(a => 
													 a.valueName).join('、');
                }
            } else {
                selectList = [];
